...
//                if ( CRElapsedMinutes < 60 || ( i===1 && mealCOB > 0 ) || !CRDatum.CRInitialIOB ) {
        ...
        if (mealCOB > 0 || absorbing || mealCarbs > 0) {
          ...
          if ((iob.iob > 2 * currentBasal || deviation > 6 || uam) && (wizardCarbsPending == 0) ) {
            if (deviation > 0) {
                uam = 1;
            } else {
                uam = 0;
        ...
        console.error(
            ...
            " IOB "+iob.iob.toFixed(3).padStart(5,' ')+" ="+iob.bolusiob.toFixed(3).padStart(6,' ')+( iob.basaliob < 0 ? " -" : " +" ) +Math.abs(iob.basaliob).toFixed(3).padStart(6,' '),
