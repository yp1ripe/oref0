...
function categorizeBGDatums(opts) {
    ...
    for (i=bucketedData.length-5; i >= 0; --i) {
        ...
        console.error(absorbing.toString(),"COB:"+mealCOB.toFixed(1),"Carbs:"+mealCarbs.toFixed(1),"BGI:"+BGI.toFixed(1),"IOB:"+iob.iob.toFixed(3)+"("+iob.bolusiob.toFixed(3)+","+iob.basaliob.toFixed(3)+")","at",BGTime,"dev:"+dev5m,"ci",ci,"avgDev:"+deviation,"avgDelta:"+avgDelta,type,BG,myCarbs);
    }
