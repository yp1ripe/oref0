...
function categorizeBGDatums(opts) {
    ...
    for (i=bucketedData.length-5; i > 0; --i) {
        ...
        if (mealCOB > 0 && absorbing || calculatingCR ) {
            ...
            } else if ( mealCOB == 0 && absorbing && deviation <= 1.5 ) {
                absorbing = 0;
            }
        ...
        console.error(absorbing.toString(),"mealCOB:",mealCOB.toFixed(1),"mealCarbs:",mealCarbs.toFixed(1),"BGI:",BGI.toFixed(1),"IOB:",iob.iob.toFixed(1),"at",BGTime,"dev:",dev5m,"ci",ci,"avgDev:",deviation,"avgDelta:",avgDelta,type,BG,myCarbs);
    }
