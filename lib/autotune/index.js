...
function tuneAllTheThings (inputs) {
    ...
    CRData.forEach(function(CRDatum) {
        ...
        var CRIOBChange = CRDatum.CRInitialIOB - CRDatum.CREndIOB;
        ...
        console.error(
            ...
            Math.round( CRDatum.CRInitialIOB * 1000)/1000, "-", Math.round( CRDatum.CREndIOB * 1000)/1000, "+",
        ...
        //);
        console.error(
            "    mealCSF (mmol/l):",Math.round( mealCSF/18.018018*10000 )/10000+" =", 
        ...
        console.error(
            "    naiveISF(mmol/l):",mealISFmmol," =", Math.round( mealCSF/18.018018*10000 )/10000, "*", CR
        );
    ...
    console.error("Total:");
    console.error(
        "    CR:              ", totalCR, " = ", CRTotalCarbs,"/",CRTotalInsulin
    );
    console.error(
