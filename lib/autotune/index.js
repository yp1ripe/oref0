    ...
    for (var hour=0; hour < 24; hour++) {
        ...
        if (basalNeeded > 0 ) {
            ...
            for (var offset=-5; offset <= 0; offset++) {
                ...
                newHourlyBasalProfile[offsetHour].rate += basalNeeded * actFractions[Math.abs(offset)];
        ...
        // and adjust all of them downward proportionally
            ...
            for (offset=-5; offset <= 0; offset++) {
                ...
                var newHourlyBasal = (newHourlyBasalProfile[offsetHour].rate -Math.abs(basalNeeded) * actFractions[ Math.abs(offset)]);
                if( newHourlyBasal <= 0 ) {
                    if ( roundTo )
