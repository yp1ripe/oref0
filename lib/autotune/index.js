...
function tuneAllTheThings (inputs) {
    ...
    CRData.forEach(function(CRDatum) {
        ...
        var scaleFactor = 1;
        var CRMaxIncrease = CRDatum.CRMaxBG.val - CRDatum.CRInitialBG;
        ...
        if (CRDatum.CRInsulinTotal > 0) {
            ...
            scaledInsulin += CRDatum.CRInsulinTotal*scaleFactor;
        ...
        console.error(
            "    CRMaxIncrease: ",  CRDatum.CRMaxBG.val, " - ", CRDatum.CRInitialBG, " = ",CRMaxIncrease 
        );
        console.error(
